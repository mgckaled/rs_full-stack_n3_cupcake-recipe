...
export function App() {
  return (
    <div className='app-container'>
      <div className='page'>
        <img src={mainImage} alt='Imagem de um cupcake com grãos de café e um chantilly' />
        ...
        <main className='main-content'>
          <section className='about'>
            ...
            <p>
              <strong>Tempo:</strong> 1h10 <br />
              <strong>Rendimento:</strong> 12 porções <br />
              <strong>Dificuldade:</strong> fácil
            </p>
          </section>
          ...
          <section className='preparation'>
            ...
            <p>
              ...
              forminhas para cupcakes forradas com forminhas de papel e coloque em uma fôrma grande, um ao lado do
              outro. Leve ao forno médio, preaquecido, por 25 minutos ou até assar e dourar. Retire e deixe esfriar.
              <br />
              <br />
              Para o recheio, leve todos os ingredientes ao fogo médio, mexendo bem até engrossar. Desligue, deixe
              esfriar e coloque dentro de um saco de confeiteiro com bico perle. Reserve. Coloque o chantilly dentro de
              um saco de confeiteiro com bico pitanga e reserve.
              <br />
              <br />
              Para a montagem, faça um furo no centro dos cupcakes e recheie com o brigadeiro de café reservado. Decore
              as superfícies dos cupcakes com o chantilly reservado, fazendo círculos. Decore com grãos de café e leve à
      ...
      <footer className='footer'>
        Feito com&nbsp;
        <img src={heart} alt='Coraçãozinho fofinho' className='icon' />
        &nbsp;por Marcel Kaled
      </footer>
    </div>
  )
